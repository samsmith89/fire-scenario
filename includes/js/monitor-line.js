 ...
 */
  ...
  if (randCoef == 2) {
  	...
  	document.querySelector(".scene-8").innerHTML = "3 inch";
  };
...
if (randCoef2 == 15.5) {
	document.querySelector(".scene-8-2").innerHTML = "1.75 inch";
} if (randCoef2 == 2) {
	document.querySelector(".scene-8-2").innerHTML = "2.5 inch";
};
...
//output of the values for the HTML
document.querySelector(".scene-1-2").innerHTML = randCoef2;
document.querySelector(".scene-2-2").innerHTML = randGPM2;
//document.querySelector(".scene-rand-gpm-2").innerHTML = randGPM2;
document.querySelector(".scene-3-2").innerHTML = randLength2;
document.querySelector(".scene-4-2").innerHTML = totalFriction2();
document.querySelector(".scene-5-2").innerHTML = randLength2;
document.querySelector(".scene-6-2").innerHTML = randNozzle2;
//document.querySelector(".scene-7-2").innerHTML = randElevation;
